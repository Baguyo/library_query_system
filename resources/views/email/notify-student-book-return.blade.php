...
<div dir="ltr" style="background-color: #f7f7f7">
    ...
    <div
        ...
        <h3> Hello! {{$transaction->user->name}} The book you borrowed {{$transaction->book->name}} must be returned
            before the closing time of the library. Otherwise you will be in penalty.
             &nbsp;
            <br>
        </h3>
